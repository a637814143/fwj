...
VALUES
    ('seller01', 'LmWJp2WUIayAIRy6', '卖家小李', 'SELLER', 0, NULL, NULL, NULL, 0, NULL, 100, 0, 0),
    ('buyer01', 'JJ5JAIcLFKuAnx09', '买家小王', 'BUYER', 0, NULL, NULL, NULL, 0, NULL, 100, 0, 0),
    ('admin', 'JIqFqTSKAUuAnx09', '系统管理员', 'ADMIN', 0, NULL, NULL, NULL, 0, NULL, 100, 0, 0)
...
CREATE TABLE IF NOT EXISTS house_orders (
    ...
    amount DECIMAL(18,2) NOT NULL,
    payment_method VARCHAR(20) NOT NULL DEFAULT 'FULL',
    status VARCHAR(20) NOT NULL DEFAULT 'PENDING',
    progress_stage VARCHAR(20) NOT NULL DEFAULT 'RESERVED',
